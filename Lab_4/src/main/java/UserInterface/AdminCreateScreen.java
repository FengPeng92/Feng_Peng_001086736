...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    AdminCreateScreen(JPanel panelRight, Admin admin) {
        initComponents();
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        Border borderRed = BorderFactory.createBevelBorder(BevelBorder.RAISED , Color.RED, Color.RED, Color.RED, Color.RED);
        Border borderBlack = BorderFactory.createBevelBorder(BevelBorder.RAISED , Color.BLACK, Color.BLACK, Color.BLACK, Color.BLACK);
        if (!usernamePatternCorrect()) {
            txtUser.setBorder(borderRed);
            JOptionPane.showMessageDialog(null, "Username Pattern is not correct", "warning",JOptionPane.WARNING_MESSAGE);
        } else if (!passwordPatternCorrect()) {
            txtUser.setBorder(borderBlack);
            txtPword.setBorder(borderRed);
            JOptionPane.showMessageDialog(null, "Password Pattern is not correct", "warning",JOptionPane.WARNING_MESSAGE);
        } else if (!txtPword.getText().equals(txtRePword.getText())) {
            txtRePword.setBorder(borderRed);
            JOptionPane.showMessageDialog(null, "Password is not same", "warning",JOptionPane.WARNING_MESSAGE);
        } else {
            txtUser.setBorder(borderBlack);
            txtPword.setBorder(borderBlack);
            txtRePword.setBorder(borderBlack);
            if (radioCustomer.isSelected()) {
                Customer customer = new Customer(txtUser.getText(), txtPword.getText());
                boolean isExisted = false;
                for (User user : custDir.getCustomerList()) {
                    if (user.getUserName().equals(customer.getUserName())) {
                        isExisted = true;
                        JOptionPane.showMessageDialog(null, "Username alrealy existed", "warning",JOptionPane.WARNING_MESSAGE);
                        break;
                    }
                }
                if (!isExisted) {
                    custDir.getCustomerList().add(customer);
                    JOptionPane.showMessageDialog(null, "Account successfully created!");
                }
                
            } else if (radioSupplier.isSelected()) {
                Supplier supplier = new Supplier(txtUser.getText(), txtPword.getText());
                boolean isExisted = false;
                for (User user : suppDir.getSupplierList()) {
                    if (user.getUserName().equals(supplier.getUserName())) {
                        isExisted = true;
                        JOptionPane.showMessageDialog(null, "Username alrealy existed", "warning",JOptionPane.WARNING_MESSAGE);
                        break;
                    }
                ...
                if (!isExisted) {
                    suppDir.getSupplierList().add(supplier);
                    JOptionPane.showMessageDialog(null, "Account successfully created!");
                }
            }
        }
