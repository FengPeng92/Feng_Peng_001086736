...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        helper.getMostLikedCommentsPost();
        
        helper.getPostWithMostComments();
        
        helper.topFiveInactivePostsNumber();
        helper.getFiveInactiveUserByComments();
        helper.getFiveInactiveUserOverall();
        helper.getFiveProactiveUserOverall();
    }
}
